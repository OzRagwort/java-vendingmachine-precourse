...
public enum ErrorMessage {
	ERROR_MESSAGE("[ERROR] "),
	AMOUNT_NUMBER_FORMAT_ERROR_MESSAGE(ERROR_MESSAGE.get() + "금액은 숫자(0 ~ 2,147,483,647)로 입력해주세요."),
	...
	QUANTITY_NUMBER_FORMAT_ERROR_MESSAGE(ERROR_MESSAGE.get() + "수량은 숫자(0 ~ 2,147,483,647)로 입력해주세요."),
